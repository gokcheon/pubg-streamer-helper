...
rem ── 회귀 테스트 캡처 52장 준비 (zip 용량 제한으로 빠져 있으면 a27 폴더에서 자동 복사)
if exist "tests\regression\captures\1.png" goto :caps_ok
set "CAPSRC="
if exist "..\pubg_streamer_helper_1.0_fix_a27\tests\regression\captures\1.png" set "CAPSRC=..\pubg_streamer_helper_1.0_fix_a27\tests\regression\captures"
if not defined CAPSRC if exist "..\pubg_streamer_helper_1.0_fix_a25\tests\regression\captures\1.png" set "CAPSRC=..\pubg_streamer_helper_1.0_fix_a25\tests\regression\captures"
