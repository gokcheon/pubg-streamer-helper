...
set "CAPSRC="
if exist "..\pubg_streamer_helper_1.0_fix_a31\tests\regression\captures\1.png" set "CAPSRC=..\pubg_streamer_helper_1.0_fix_a31\tests\regression\captures"
if not defined CAPSRC if exist "..\pubg_streamer_helper_1.0_fix_a30\tests\regression\captures\1.png" set "CAPSRC=..\pubg_streamer_helper_1.0_fix_a30\tests\regression\captures"
